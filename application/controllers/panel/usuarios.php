...
class Usuarios extends MY_Controller {
	 ...
	 * @var unknown_type
	 */
	private $excepcion_privilegio = array('Usuarios/ajax_get_usuario/');
  ...
  public function index()
  {
	...
	/**
	 * Obtiene lostado de usuario para el autocomplete, ajax
	 */
	public function ajax_get_usuario(){
		$this->load->model('usuarios_model');
		$params = $this->usuarios_model->getUsuariosAjax();
