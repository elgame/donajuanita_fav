...
<body>
  ...
  <div class="container-fluid" style="padding-left: 0px;">
    ...
    <div class="span3">
      <form action="<?php echo base_url('panel/reportes/bajos_inventario_pdf'); ?>" method="GET" target="rvcReporte">
        <fieldset>
          <legend>Filtros</legend>

          <div class="input-prepend">
            <span class="add-on" style="margin-right: -4px;">Proveedor</span>
            <input type="text" name="dproveedor" class="span9" id="dproveedor" value="<?php echo set_value('dproveedor'); ?>" placeholder="nombre del proveedor">
          ...
          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rvcReporte" id="iframe-reporte" class="span12" 
                src="<?php echo base_url('panel/reportes/bajos_inventario_pdf')?>" style="height:600px;">dd</iframe>
            </div>
