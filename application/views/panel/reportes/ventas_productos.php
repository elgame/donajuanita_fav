...
<body>
  ...
  <div class="container-fluid" style="padding-left: 0px;">
    ...
    <div class="span3">
      <form action="<?php echo base_url('panel/reportes/ventas_productos_pdf'); ?>" method="GET" target="rvcReporte">
        <fieldset>
          ...
          <div class="btn-group">
            <a href="<?php echo base_url('panel/reportes/ventas_productos_pdf?ffecha1='.date('Y-m-d')); ?>" class="btn" target="rvcReporte">Hoy</a>
            <a href="<?php echo base_url('panel/reportes/ventas_productos_pdf?ffecha1='.date('Y-m-').'01&ffecha2='.date('Y-m-d') ); ?>" class="btn" target="rvcReporte">Mes</a>
            <a href="<?php echo base_url('panel/reportes/ventas_productos_pdf?ffecha1='.date('Y-').'01-01&ffecha2='.date('Y-m-d') ); ?>" class="btn" target="rvcReporte">Año</a>
          </div>
          ...
          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rvcReporte" id="iframe-reporte" class="span12" 
                src="<?php echo base_url('panel/reportes/ventas_productos_pdf')?>" style="height:600px;">dd</iframe>
            </div>
